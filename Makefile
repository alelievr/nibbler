...
#	First target
all: $(NAME) $(SDLLIB) $(GLFWLIB) $(SOILLIB) $(SFMLLIB) $(FREETYPELIB) $(SERVOTRONLIB) $(OGGLIB) $(VORBISLIB) $(FLACLIB) $(SOUNDLIB) $(GLFW_NIBBLER_LIB) $(SDL_NIBBLER_LIB)# $(SFML_NIBBLER_LIB) #disbled for test
